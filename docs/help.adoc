...
Exportieren Sie eine mit 'Flight Contest' eingegebene Strecke mit 'GPX-Export' zur Weitergabe
an den Auswerte-Schiedsrichter, der diese mit 'Strecken -> Import FC-Strecke' 
