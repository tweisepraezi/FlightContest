...
Unterstützt die Logger-Datenformate GAC, GPX, IGC und NMEA 0183 (erweiterbar).
...
* Logger-Daten-Anzeige für GAC-, GPX-, IGC- und NMEA-Dateien
...
|--route
|show-curved-points
|in Strecken-Anzeigen UZKs der krummen Strecke anzeigen
|===
...
* GAC-, GPX-, IGC- oder NMEA-Dateien in das Verzeichnis "C:\FCSave\.logger" speichern
