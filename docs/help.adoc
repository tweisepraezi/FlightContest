...
im Maßstab 1:200000 mit Hilfe des Web-Dienstes Printmaps oder einem eigenen Druckserver erzeugt werden. 
Der Web-Dienst Printmaps erzeugt Karten im OSM-Carto-Stil. 
Der eigene Druckserver erzeugt Karten im OpenTopoMap-Stil.
...
[[osm-contest-map-printmaps]]
=== Web-Dienst Printmaps
...
Höhenlinien bei Printmaps-Nutzung:

* Contour data © opensnowmap.org

Höhenlinien und Oberflächenkonturen bei einem eigenen Druckserver:
...
Alle genannten Streckendetails und Objekte können i.d.R. abgewählt werden.
...
bei Printmaps-Nutzung farblich an die TÜK200-Darstellung angenähert werden. 
Die Erstellungszeit der Karte wird dadurch allerdings erheblich verlängert.

Fehlende Flupplätze, Kirchen, Burgen, Schlösser, Windkraftanlagen und Höhenpunkte
