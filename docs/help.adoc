...
* Online-Kartenanzeige mit Google Maps und Open Street Map
...
<<help.adoc#route-planning-definitions,Definitionen>> +
<<help.adoc#route-planning-mandatory-details,Erforderliche Angaben für ein Wettbewerbsstrecke>> +
<<help.adoc#route-planning-input,Eingabe von Wettbewerbsstrecken>> +
<<help.adoc#route-planning-import,Import von Wettbewerbsstrecken>> +
<<help.adoc#route-planning-google-earth,Wettbewerbsstrecken mit Google Earth Pro erstellen>> +
<<help.adoc#route-planning-verify,Prüfen der Wettbewerbsstrecke>> +
<<help.adoc#route-planning-deliver,Weitergabe der Wettbewerbsstrecke an den Auswerte-Schiedsrichter>> +
<<help.adoc#route-planning-errors,Fehlermeldungen in Streckendetails>>
...
=== Erforderliche Angaben für ein Wettbewerbsstrecke
...
Kartendaten sind für Europa aus folgenden Datenquellen verfügbar:

* Open Street Map (http://www.openstreetmap.org)
* U.S. Geological Survey (http://dds.cr.usgs.gov/srtm/version2_1/SRTM3)
* J. de Ferranti (http://www.viewfinderpanoramas.org)
...
Folgende Objekte können in die Karte gezeichnet werden (Urheber):

* Höhenlinen (U.S. Geological Survey, J. de Ferranti)
* Gradnetz
...
* GM_Utils-5.21 - GPX-Viewer-JavaScript-Bibliothek
...
Passen Sie in GPX2GM_Defs.js die Variable JB.GPX2GM.GM_Api_key an und setzen Sie 
einen Goggle Maps API-Key:

 JB.GPX2GM.GM_Api_key = "API Key"
...
<<<
=== Google-Maps-Anzeige konfigurieren
 flightcontest {
   maps {
     gm_api_key = "..." // Goggle Maps API-Key
   }
 }
...
=== OSM-Druck-Server konfigurieren
 flightcontest {
   contestmap {
     printserverapi = "http://printmaps-osm.de:8181/api/beta/maps"
   }
 }
