...
Besatzung muß wegen Defekt das Flugzeug wechseln::
  Besatzung das neue Flugzeug und ggf. eine andere TAS zuweisen
     (Besatzungen)
...
Wendepunkt-Überflugzeit einer Aufgabe soll nicht gewertet werden::
  'Zeitauswertung' des Wendepunktes deaktivieren
...
Zeitplan einer Aufgabe neu berechnen::
  'Reihenfolge zurücksetzen' und 'Zeitplan berechnen' 
...
deren Aufbau einen erfolgreichen Import sicherstellt.
...
auch mit Textdateien möglich. In einer leeren Strecke können alle Check-Punkte mit 
"Koordinaten importieren" aus einer Text-Datei hinzugefügt werden (einschl. Eigenschaften):
  
 TO, Lat 48° 46.66700' N, Lon 010° 15.79600' E, Alt 1915ft, Gate 270° 1.0NM
 ...
 LDG, Lat 48° 46.68300' N, Lon 010° 16.05600' E, Alt 1915ft, Gate 270° 1.0NM
...
|LegTime|Interne Funktion zur windabhängigen Flugzeitberechnung
