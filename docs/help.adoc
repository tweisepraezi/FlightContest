...
* link:rules/FAI_rally_flying_rules_2019.pdf[FAI Air Rally Flying^]
* link:rules/FAI_precision_flying_rules_2019.pdf[FAI Precision Flying^]
...
im Maßstab 1:200000 mit Hilfe eines eigenen Druckserver im TÜK200-Stil erzeugt werden. 
...
* link:rules/FAI_rally_flying_rules_2019.pdf#page=17[FAI Air Rally Flying - Edition 2019^] ((alle Landungen)

  {x -> switch(x.toUpperCase()){case '0':return 0;case 'A':return 10;case 'B':return 20;case 'C':return 30;case 'D':return 40;case 'E':return 60;case 'F':return 80;case 'G':return 100;case 'H':return 120;case 'X':return 60;case 'Y':return 120;default:return null;}}

* link:rules/FAI_precision_flying_rules_2019.pdf#page=20[FAI Precision Flying - Edition 2019^]
** Landung 1 und 4
...
** Flugplan - Wendepunkte-Nummer ab WP3 um 1 erhöhen (druckt WP3 als WP4, WP4 als WP5 usw.)

 body { --route: Strecke-1; --start-tp: TP3; --add-num: 1; }

** Flugplan - Wendepunkte-Nummer ab WP3 um 1 erhöhen, ab WP5 um weitere 2 erhöhen

 body { --route: Strecke-1; --start-tp: TP3,TP5; --add-num: 1,2; }
...
* GM_Utils-6.2 - GPX-Viewer-JavaScript-Bibliothek
...
|contestmap.projection|Andere Projektion der OSM-Wettbewerbs-Kartenerzeugung festlegen (EPSG-Nummer)
|contestmap.showoptions|Blendet beim OSM-Wettbewerbs-Karten-Dialog zusätzliche Optionen ein
|===
