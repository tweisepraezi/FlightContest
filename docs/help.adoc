...
|timetablejurylist|value [#crew.num]|num crew aircraft aircrafttype aircraftcolor tas team resultclass shortresultclass planningtime planningendtime takeofftime sptime tptime fptime landingtime arrivaltime empty1 empty2 empty3 empty4
