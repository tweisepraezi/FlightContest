...
airfield.png, church.png, castle.png, castle_ruin.png, chateau.png, windpowerstation.png, peak.png
...
* link:rules/FAI_rally_flying_rules_2020.pdf#page=17[FAI Air Rally Flying - Edition 2020^] ((alle Landungen)
