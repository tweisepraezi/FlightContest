enum ContestRules 
{
	...
	R4 ('fc.contestrule.fai.precision.2016',
		[
			// General
			precisionFlying:true,
			printPointsPlanningTest:true,
    ...
    R6 ('fc.contestrule.fai.rally.2016.advanced',
        [
            // General
            precisionFlying:false,
            printPointsPlanningTest:false,
            ...
            flightTestTakeoffCheckSeconds:true,
            flightTestTakeoffPointsPerSecond:3,
            flightTestCptimeCorrectSecond:5,
            flightTestCptimePointsPerSecond:3,
            flightTestCptimeMaxPoints:100,
            flightTestCpNotFoundPoints:100,
            flightTestProcedureTurnNotFlownPoints:0,
    ...
    R7 ('fc.contestrule.at.precision.2016.landing1',
        [
            // General
            precisionFlying:true,
            printPointsPlanningTest:true,
            ...
            landingTest1GoAroundWithoutTouchingPoints:0,
            landingTest1GoAroundInsteadStopPoints:0,
            landingTest1AbnormalLandingPoints:100,
            landingTest1NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest1PenaltyCalculator:"{x -> switch(x.toUpperCase()){case '0':return 0;case 'C':return 60;case 'A':return 20;case 'I':return 10;case 'II':return 30;case 'III':return 50;default:return null;}}",
            ...
            landingTest2GoAroundWithoutTouchingPoints:0,
            landingTest2GoAroundInsteadStopPoints:0,
            landingTest2AbnormalLandingPoints:100,
            landingTest2NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest2PowerInAirPoints:100,
            landingTest2PenaltyCalculator:"{x -> switch(x.toUpperCase()){case '0':return 0;case 'C':return 60;case 'A':return 20;case 'I':return 10;case 'II':return 30;case 'III':return 50;default:return null;}}",
            ...
            landingTest3GoAroundWithoutTouchingPoints:0,
            landingTest3GoAroundInsteadStopPoints:0,
            landingTest3AbnormalLandingPoints:100,
            landingTest3NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest3PowerInAirPoints:100,
            landingTest3FlapsInAirPoints:100,
            landingTest3PenaltyCalculator:"{x -> switch(x.toUpperCase()){case '0':return 0;case 'C':return 60;case 'A':return 20;case 'I':return 10;case 'II':return 30;case 'III':return 50;default:return null;}}",
            
            landingTest4MaxPoints:200,
            landingTest4NoLandingPoints:200,
            landingTest4OutsideLandingPoints:200,
            ...
            landingTest4GoAroundWithoutTouchingPoints:0,
            landingTest4GoAroundInsteadStopPoints:0,
            landingTest4AbnormalLandingPoints:100,
            landingTest4NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest4TouchingObstaclePoints:100,
            landingTest4PenaltyCalculator:"{x -> switch(x.toUpperCase()){case '0':return 0;case 'C':return 60;case 'A':return 20;case 'I':return 10;case 'II':return 30;case 'III':return 50;default:return null;}}",
        ]
    ),
    R8 ('fc.contestrule.at.precision.2016.landing2',
        [
            // General
            precisionFlying:true,
            printPointsPlanningTest:true,
            ...
            landingTest1AbnormalLandingPoints:100,
            landingTest1NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest1PenaltyCalculator:"{x -> if(x.isInteger()){i=x.toInteger();if(i>0){return 2*i}else{return -(4*i)}}else{switch(x.toUpperCase()){case '0':return 0;case 'C':return 60;case 'B':return 40;case 'A':return 20;case 'I':return 10;case 'II':return 20;case 'III':return 30;case 'IV':return 40;case 'V':return 50;case 'VI':return 60;default:return null;}}}",
    ...
    R9 ('fc.contestrule.at.precision.2016.landing3',
        [
            // General
            precisionFlying:true,
            printPointsPlanningTest:true,
            ...
            printPointsLandingTest3:true,
            printPointsLandingTest4:true,
            printLandingCalculatorValues:"-10,10",
            ...
            landingTest1AbnormalLandingPoints:100,
            landingTest1NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest1PenaltyCalculator:"{x -> if(x.isInteger()){i=x.toInteger();if(i>0){return 2*i}else{return -(3*i)}}else{return null;}}",
            ...
            landingTest2NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest2PowerInAirPoints:100,
            landingTest2PenaltyCalculator:"{x -> if(x.isInteger()){i=x.toInteger();if(i>0){return 2*i}else{return -(3*i)}}else{return null;}}",
            ...
            landingTest3PowerInAirPoints:100,
            landingTest3FlapsInAirPoints:100,
            landingTest3PenaltyCalculator:"{x -> if(x.isInteger()){i=x.toInteger();if(i>0){return 2*i}else{return -(3*i)}}else{return null;}}",
            ...
            landingTest4NotAllowedAerodynamicAuxiliariesPoints:0,
            landingTest4TouchingObstaclePoints:100,
            landingTest4PenaltyCalculator:"{x -> if(x.isInteger()){i=x.toInteger();if(i>0){return 2*i}else{return -(3*i)}}else{return null;}}",
        ]
    ),
    R10 ('fc.contestrule.at.nav.2016',
        [
            // General
            precisionFlying:false,
            printPointsPlanningTest:false,
            ...
            flightTestBadCoursePoints:200,
            flightTestBadCourseStartLandingPoints:0,
            flightTestLandingToLatePoints:300,
            flightTestGivenToLatePoints:300,
            flightTestSafetyAndRulesInfringementPoints:600,
            flightTestInstructionsNotFollowedPoints:200,
            flightTestFalseEnvelopeOpenedPoints:100,
