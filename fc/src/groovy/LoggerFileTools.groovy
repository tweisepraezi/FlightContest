class LoggerFileTools
{
    ...
    final static String LOGGER_EXTENSIONS = "${LoggerFileTools.GAC_EXTENSION}, ${LoggerFileTools.GPX_EXTENSION}, ${LoggerFileTools.IGC_EXTENSION}, ${LoggerFileTools.NMEA_EXTENSION}"
