...
=== Lokalen Karten-Druck-Server konfigurieren
 flightcontest {
   maps {
     srtm {
        username = "TODO"     // User-Name für Zugriff auf SRTM-Daten
        password = "TODO"     // Passwort für Zugriff auf SRTM-Daten
     }
     postgresql {
        ...
        username = "postgres" // User-Name für Zugriff auf lokalen PostgreSQL-Server
