...
[%autowidth]
|===
|server|Adresse des Live-Tracking-Servers
|token|Token, mit dem der Zugriff auf den Live-Tracking-Server ermöglicht wird
|contest.showDelete|Löschen von Live-Tracking-Contests ermöglichen
|contest.createPublic|Öffentliche Live-Tracking-Contests anlegen
|contest.startLocalTimeOfDay|Lokale Start-Zeit des Live-Tracking-Contests am Wettbewerbstag
|contest.endLocalTimeOfDay|Lokale End-Zeit des Live-Tracking-Contests am Wettbewerbstag
|contest.timeZone|Zeit-Zone des Live-Tracking-Contests
|navigationtask.showDelete|Löschen von Live-Tracking-Navigationtasks ermöglichen
|navigationtask.createPublic|Öffentliche Live-Tracking-Navigationtasks anlegen
|contestant.minutesBetweenTrackerStartAndTakeoff|Trackeraufzeichnung beginnt angegebene Minuten vor Takeoff
|===
...
* Scenario 1: Airsports Live Tracking mit Flight Contest konfigurieren

** Vorbereitende Schritte in Flight Contest
*** Allen Besatzungen die Tracker-ID ihres Trackers zuweisen. +
-> Besatzungen -> <Besatzungs-Name> -> Tracker-ID
        
** Auszuführende Funktionen in Flight Contest
*** Live-Tracking-Contest anlegen +
-> Wettbewerb -> Einstellungen -> Live-Tracking -> Contest-Datum +
-> Wettbewerb -> Einstellungen -> Live-Tracking -> Contest anlegen
*** Live-Tracking-Navigation-Task anlegen +
-> Aufgaben -> <Aufgaben-Name> -> Einstellungen -> Live-Tracking -> Navigation-Task-Datum +
-> Aufgaben -> <Aufgaben-Name> -> Einstellungen -> Live-Tracking -> Navigation-Task anlegen
        
** Auszuführende Funktionen in Airsports Live Tracking
*** Live-Tracking-Contest und -Navigation-Task für öffentlichen Zugriff freischalten

* Scenario 2: Flight Contest mit Airsports Live Tracking Teams konfigurieren

** Vorbereitende Schritte in Airsports Live Tracking
*** Live-Tracking-Contest anlegen
*** Teams zuordnen (Namen, Club, Land, Fotos, Flugzeuge, TAS, Tracker-ID)

** Auszuführende Funktionen in Flight Contest
*** Verbinden mit Live-Tracking-Contest +
-> Wettbewerb -> Einstellungen -> Live-Tracking -> Contest verbinden
*** Teams aus Live-Tracking-Contest als Besatzungen importieren +
-> Besatzungen -> Live-Tracking-Teams importieren
*** Zeitplan für Navigations-Flug in Aufgabe berechnen
*** Live-Tracking-Navigation-Task anlegen +
-> Aufgaben -> <Aufgaben-Name> -> Einstellungen -> Live-Tracking -> Navigation-Task-Datum +
-> Aufgaben -> <Aufgaben-Name> -> Einstellungen -> Live-Tracking -> Navigation-Task anlegen
