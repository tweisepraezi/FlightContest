...
"Erzeugen" ausführen +
+
Die erzeugte Karte ist mit der aktivierten Einstellung "Diese Karte als Default-Online-Karte für diese Strecke einstellen"
und "Diese Karte als Default-Druck-Karte für diese Strecke einstellen" mit "Karte speichern und zur Liste der Karten wechseln" zu speichern. +
+
