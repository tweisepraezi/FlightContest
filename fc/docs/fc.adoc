...
- Strecke -> OSM-Wettbewerbs-Karte -> *Online-Karte um Flughafen erzeugen*
- Strecke -> OSM-Wettbewerbs-Karte -> *Task-Creator-Karte um Flughafen erzeugen*
...
=== Original-Task-Creator für Nutzung konfigurieren
 flightcontest {
   taskcreator {
     url = "https://www.airrats.cl/taskcreator/?lang=en&admin"
   }
 }
