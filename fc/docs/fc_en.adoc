...
Run “Generate” +
+
The generated map is to be saved with the activated settings “Set this map as the default online map for this route”
and ‘Set this map as the default print map for this route’ with ‘Save map and switch to the list of maps’. +
+
