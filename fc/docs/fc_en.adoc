...
=== Configure local map print server
 flightcontest {
   maps {
     srtm {
        username = "TODO"     // User name for accessing SRTM data
        password = "TODO"     // Password for accessing SRTM data
     }
     postgresql {
        ...
        username = "postgres" // User name for accessing the local PostgreSQL server
