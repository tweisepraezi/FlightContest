...
=== Configure FTP dispatch
 flightcontest {
   ftp {
     ...
     contesturl = "TODO" // Public access to contest directory
                         // on FTP server (e.g. "http://results.flightcontest.de/demo")
...
* GM_Utils-6.2 - GPX viewer JavaScript library.
...
[%autowidth]
|===
|server|address of the live tracking server
|token|Token used to enable access to the live tracking server
|contest.showDelete|Enable deletion of live tracking contests
|contest.createPublic|Create public live tracking contests
|contest.startLocalTimeOfDay|Local start time of live tracking contest on contest day
|contest.endLocalTimeOfDay|Local end time of the live tracking contest on the contest day
|contest.timeZone|Time zone of the live tracking contest
|navigationtask.showDelete|Enable deletion of live tracking navigation tasks
|navigationtask.createPublic|Create public live tracking navigation tasks
|contestant.minutesBetweenTrackerStartAndTakeoff|Tracker recording starts specified minutes before takeoff
|===
...
[%autowidth]
|===
|contestmap.printserverapi|Address of the print server for OSM contest map generation
|contestmap.projection|Set other projection of OSM contest map generation (EPSG number)
|contestmap.devoptions|Show additional devoptions in the OSM contest map dialog
|===
...
[%autowidth]
|===
|wrlog.enable|Enable writing logs to <installation directory>\fc\logs
|===
