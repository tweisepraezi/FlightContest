class DemoContestRoutesService
{
    ...
    long CreateTest(String testName, String printPrefix, boolean testExists, boolean aflosDB, String showLanguage) 
    {
		...
		Map route5m = fcService.putRoute(contest,ROUTE_5M,ROUTE_5M,TurnpointRoute.None,EnrouteRoute.None,EnrouteRoute.None,EnrouteMeasurement.None,EnrouteMeasurement.None)
		create_route(route5m, ROUTE_5M, showLanguage)
		fcService.printdone ""
		
        fcService.printstart ROUTE_6M
		Map route6m = fcService.putRoute(contest,ROUTE_6M,ROUTE_6M,TurnpointRoute.None,EnrouteRoute.None,EnrouteRoute.None,EnrouteMeasurement.None,EnrouteMeasurement.None)
		create_route(route6m, ROUTE_6M, showLanguage)
		fcService.printdone ""
		
        fcService.printstart ROUTE_7M
		Map route7m = fcService.putRoute(contest,ROUTE_7M,ROUTE_7M,TurnpointRoute.None,EnrouteRoute.None,EnrouteRoute.None,EnrouteMeasurement.None,EnrouteMeasurement.None)
		create_route(route7m, ROUTE_7M, showLanguage)
		fcService.printdone ""
	...
	void create_route(Map route, String strecke, String showLanguage) {
        String N = CoordPresentation.NORTH
        String E = CoordPresentation.EAST
		if (strecke == "Strecke 7m") {
			fcService.putCoordRoute(showLanguage,route,CoordType.TO,     0,"T/O", N,48,6.78612, E, 9, 45.6951, 1903, 1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SP,     0,"SP",  N,48,7.46118, E,9, 41.34078,2524,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     1,"CP1", N,48,5.5845,  E,9, 35.82642,2413,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     2,"CP2", N,48,13.21854,E,9, 29.25354,2245,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     3,"CP3", N,48,14.97018,E,9, 44.7258, 2131,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     4,"CP4", N,48,19.45464,E,9, 43.81206,2226,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     5,"CP5", N,48,28.88394,E,9, 54.42102,2554,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     6,"CP6", N,48,28.2984, E,10,4.75254, 2124,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     7,"CP7", N,48,21.54018,E,10,9.18834, 2085,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     8,"CP8", N,48,14.57244,E,10,12.99804,2209,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.iFP,    0,"iFP", N,48,12.14622,E,10,4.4004,  2193,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.iLDG,   0,"iLDG",N,48,13.19832,E,9, 54.72876,500, 1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.iSP,    0,"iSP", N,48,12.25446,E,9, 46.19184,2203,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     9,"CP9", N,48,8.17152, E,9, 53.05554,2259,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,    10,"CP10",N,48,6.89436, E,9, 59.77026,2308,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 1,"CP11",N,48,5.26938, E,9, 59.85162,2452,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 2,"CP12",N,48,3.87882, E,9, 59.34978,2505,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 3,"CP13",N,48,3.16764, E,9, 58.90962,2613,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 4,"CP14",N,48,2.12592, E,9, 57.98466,2531,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 5,"CP15",N,48,1.38588, E,9, 57.10206,2646,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 6,"CP16",N,48,0.57762, E,9, 55.63968,2731,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 7,"CP17",N,47,59.82114,E,9, 53.72874,2669,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 8,"CP18",N,47,59.47158,E,9, 52.1712, 2724,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 9,"CP19",N,47,59.28024,E,9, 50.32314,2537,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,10,"CP20",N,47,59.24022,E,9, 49.1409, 2439,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,11,"CP21",N,47,59.35428,E,9, 47.49078,2423,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,12,"CP22",N,47,59.91636,E,9, 44.94666,2432,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,13,"CP23",N,48,0.45312, E,9, 43.71606,2419,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,14,"CP24",N,48,1.11954, E,9, 42.42648,2413,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,15,"CP25",N,48,1.60434, E,9, 41.68098,2409,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,16,"CP26",N,48,2.47332, E,9, 40.7391, 2446,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,17,"CP27",N,48,3.26796, E,9, 40.04532,2432,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,18,"CP28",N,48,4.42632, E,9, 39.41616,2478,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,19,"CP29",N,48,5.61012, E,9, 39.06072,2406,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,20,"CP30",N,48,6.55188, E,9, 39.03636,2537,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,21,"CP31",N,48,7.07484, E,9, 39.1155, 2455,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,    11,"CP32",N,48,8.02164, E,9, 39.15162,2491,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.FP,     0,"FP",  N,48,9.02784, E,9, 43.24464,2347,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.LDG,    0,"LDG", N,48,6.86658, E,9, 45.7728, 1903,1.0, null, null)
			...
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     7,"CP7", N,48,21.54018,E,10,9.18834, 2085,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     8,"CP8", N,48,14.57244,E,10,12.99804,2209,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,     9,"CP9", N,48,12.14622,E,10,4.4004,  2193,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 1,"CP10",N,48,13.19832,E,9, 54.72876,500, 1.0, null, null)
			if (strecke == "Strecke 6m") {
				fcService.putCoordRoute(showLanguage,route,CoordType.TP,10,"CP11",N,48,12.25446,E,9, 46.19184,2203,1.0, null, 132)
			} else {
				fcService.putCoordRoute(showLanguage,route,CoordType.TP,10,"CP11",N,48,12.25446,E,9, 46.19184,2203,1.0, null, null)
			}
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,    11,"CP12",N,48,8.17152, E,9, 53.05554,2259,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,    12,"CP13",N,48,6.89436, E,9, 59.77026,2308,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 2,"CP14",N,48,5.26938, E,9, 59.85162,2452,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 3,"CP15",N,48,3.87882, E,9, 59.34978,2505,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 4,"CP16",N,48,3.16764, E,9, 58.90962,2613,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 5,"CP17",N,48,2.12592, E,9, 57.98466,2531,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 6,"CP18",N,48,1.38588, E,9, 57.10206,2646,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 7,"CP19",N,48,0.57762, E,9, 55.63968,2731,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 8,"CP20",N,47,59.82114,E,9, 53.72874,2669,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET, 9,"CP21",N,47,59.47158,E,9, 52.1712, 2724,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,10,"CP22",N,47,59.28024,E,9, 50.32314,2537,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,11,"CP23",N,47,59.24022,E,9, 49.1409, 2439,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,12,"CP24",N,47,59.35428,E,9, 47.49078,2423,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,13,"CP25",N,47,59.91636,E,9, 44.94666,2432,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,14,"CP26",N,48,0.45312, E,9, 43.71606,2419,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,15,"CP27",N,48,1.11954, E,9, 42.42648,2413,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,16,"CP28",N,48,1.60434, E,9, 41.68098,2409,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,17,"CP29",N,48,2.47332, E,9, 40.7391, 2446,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,18,"CP30",N,48,3.26796, E,9, 40.04532,2432,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,19,"CP31",N,48,4.42632, E,9, 39.41616,2478,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,20,"CP32",N,48,5.61012, E,9, 39.06072,2406,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,21,"CP33",N,48,6.55188, E,9, 39.03636,2537,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.SECRET,22,"CP34",N,48,7.07484, E,9, 39.1155, 2455,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.TP,    13,"CP35",N,48,8.02164, E,9, 39.15162,2491,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.FP,     0,"FP",  N,48,9.02784, E,9, 43.24464,2347,1.0, null, null)
			fcService.putCoordRoute(showLanguage,route,CoordType.LDG,    0,"LDG", N,48,6.86658, E,9, 45.7728, 1903,1.0, null, null)
		}
	}
