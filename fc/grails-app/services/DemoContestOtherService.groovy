...
class DemoContestOtherService
{
	...
	long CreateTest11(String testName, String printPrefix, boolean testExists)
	{
        ...
        // Tasks
        Map task1 = fcService.putTask(contest,"Task-1","09:00",3,5,false,false, true,false,false, false,true, true,false,false, false,false,false,false, false,false,false, false,false)
        Map task2 = fcService.putTask(contest,"Task-2","09:00",3,5,false,false, false,true,false, false,true, true,false,false, false,false,false,false, false,false,false, false,false)
	...
	long CreateTest12(String testName, String printPrefix, boolean testExists)
	{
        ...
        // Tasks
        Map task1 = fcService.putTask(contest,"Task-1","09:00",3,5,true,true,true,true,false, false,true, true,false,false, false,false,false,false, false,false,false, false,false)
        Map task2 = fcService.putTask(contest,"Task-2","09:00",3,5,true,true,true,true,false, false,true, true,false,false, false,false,false,false, false,false,false, false,false)
	...
	long CreateTest13(String testName, String printPrefix, boolean testExists)
	{
        ...
        Map task1 = fcService.putTask(contest,"","11:00",3,5,true,true,true,true,false, false,true, true,false,false, false,false,false,false, false,false,false, false,false)
