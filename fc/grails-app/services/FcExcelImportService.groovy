// modified ExcelImportService, see TODO
// Thomas Weise
...
import org.grails.plugins.excelimport.HorizontalExcelImporter
import org.grails.plugins.excelimport.ImportCellCollector
import org.grails.plugins.excelimport.ImportSeverityMappingEnum
import org.grails.plugins.excelimport.NoopImportCellCollector
 ...
 * Time: 5:08:39 PM
 */
public class FcExcelImportService {
	...
	static ExpectedPropertyType PROPERTY_TYPE_INT = ExpectedPropertyType.IntType
	static ExpectedPropertyType PROPERTY_TYPE_STRING = ExpectedPropertyType.StringType
	static ExpectedPropertyType PROPERTY_TYPE_DATE = ExpectedPropertyType.DateType
	static ExpectedPropertyType PROPERTY_TYPE_DATE_JAVA = ExpectedPropertyType.DateJavaType
	static ExpectedPropertyType PROPERTY_TYPE_DOUBLE = ExpectedPropertyType.DoubleType
	...
	def convertColumnMapOneRow(Sheet currentSheet, Map config, int rowIndex, ImportCellCollector pcc = null, FormulaEvaluator evaluator = null, propertyConfigurationMap = null) {
		...
		def returnParams = [:]
		def anyNonNullValues = true // TODO: auf true geändert, damit Leerzeilen zurückgeliefert werden
