...
class DemoContestObservationService
{
	...
	long CreateTest(String testName, String printPrefix, boolean testExists, boolean aflosDB)
	{
        ...
        // Task 1
        Map task1 = fcService.putTask(contest,"Messung durch Besatzung","10:10",2,"wind+:4NM","wind+:7.5NM",5,"wind:1","wind:1",false,true,true,false,false, false,true, true,true,true, false,false,false,false, true,true,true, false,false)
        ...
        // Task 2        
        Map task2 = fcService.putTask(contest,"Auswertung durch Schiedsrichter","10:10",2,"wind+:4NM","wind+:7.5NM",5,"wind:1","wind:1",false,true,true,false,false, false,true, true,true,true, false,false,false,false, true,true,true, false,false)
