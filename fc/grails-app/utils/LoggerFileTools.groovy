...
class LoggerFileTools
{
    ...
    //--------------------------------------------------------------------------
    static int InterpolateMissingTrackpoints(String utcLastDateTime, BigDecimal lastLatitude, BigDecimal lastLongitude, Integer lastAltitude, String utcDateTime, BigDecimal actLatitude, BigDecimal actLongitude, Integer actAltitude, def actTrack, LoggerDataTest loggerData)
