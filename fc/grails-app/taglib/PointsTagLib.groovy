class PointsTagLib 
{
    ...
    def editPoints = { attrs, body ->
        ...
        outln"""    <p/>"""
        outln"""    <div>"""
        checkBox("precisionFlying", attrs.i.precisionFlying, 'fc.general.precisionflying')
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestDirectionCorrectGrad" name="planningTestDirectionCorrectGrad" value="${fieldValue(bean:attrs.i,field:'planningTestDirectionCorrectGrad')}" tabIndex="1"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestDirectionPointsPerGrad" name="planningTestDirectionPointsPerGrad" value="${fieldValue(bean:attrs.i,field:'planningTestDirectionPointsPerGrad')}" tabIndex="2"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestTimeCorrectSecond" name="planningTestTimeCorrectSecond" value="${fieldValue(bean:attrs.i,field:'planningTestTimeCorrectSecond')}" tabIndex="3"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestTimePointsPerSecond" name="planningTestTimePointsPerSecond" value="${fieldValue(bean:attrs.i,field:'planningTestTimePointsPerSecond')}" tabIndex="4"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestMaxPoints" name="planningTestMaxPoints" value="${fieldValue(bean:attrs.i,field:'planningTestMaxPoints')}" tabIndex="5"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestPlanTooLatePoints" name="planningTestPlanTooLatePoints" value="${fieldValue(bean:attrs.i,field:'planningTestPlanTooLatePoints')}" tabIndex="6"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="planningTestExitRoomTooLatePoints" name="planningTestExitRoomTooLatePoints" value="${fieldValue(bean:attrs.i,field:'planningTestExitRoomTooLatePoints')}" tabIndex="7"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestTakeoffCorrectSecond" name="flightTestTakeoffCorrectSecond" value="${fieldValue(bean:attrs.i,field:'flightTestTakeoffCorrectSecond')}" tabIndex="11"/>"""
        ...
        outln"""        </p>"""
        outln"""        <div>"""
        checkBox("flightTestTakeoffCheckSeconds", attrs.i.flightTestTakeoffCheckSeconds, 'fc.flighttest.takeoffcheckpoints')
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestTakeoffPointsPerSecond" name="flightTestTakeoffPointsPerSecond" value="${fieldValue(bean:attrs.i,field:'flightTestTakeoffPointsPerSecond')}" tabIndex="12"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestTakeoffMissedPoints" name="flightTestTakeoffMissedPoints" value="${fieldValue(bean:attrs.i,field:'flightTestTakeoffMissedPoints')}" tabIndex="13"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestCptimeCorrectSecond" name="flightTestCptimeCorrectSecond" value="${fieldValue(bean:attrs.i,field:'flightTestCptimeCorrectSecond')}" tabIndex="14"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestCptimePointsPerSecond" name="flightTestCptimePointsPerSecond" value="${fieldValue(bean:attrs.i,field:'flightTestCptimePointsPerSecond')}" tabIndex="15"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestCptimeMaxPoints" name="flightTestCptimeMaxPoints" value="${fieldValue(bean:attrs.i,field:'flightTestCptimeMaxPoints')}" tabIndex="16"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestCpNotFoundPoints" name="flightTestCpNotFoundPoints" value="${fieldValue(bean:attrs.i,field:'flightTestCpNotFoundPoints')}" tabIndex="17"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestProcedureTurnNotFlownPoints" name="flightTestProcedureTurnNotFlownPoints" value="${fieldValue(bean:attrs.i,field:'flightTestProcedureTurnNotFlownPoints')}" tabIndex="18"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestMinAltitudeMissedPoints" name="flightTestMinAltitudeMissedPoints" value="${fieldValue(bean:attrs.i,field:'flightTestMinAltitudeMissedPoints')}" tabIndex="19"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestBadCourseCorrectSecond" name="flightTestBadCourseCorrectSecond" value="${fieldValue(bean:attrs.i,field:'flightTestBadCourseCorrectSecond')}" tabIndex="20"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestBadCoursePoints" name="flightTestBadCoursePoints" value="${fieldValue(bean:attrs.i,field:'flightTestBadCoursePoints')}" tabIndex="21"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestBadCourseStartLandingPoints" name="flightTestBadCourseStartLandingPoints" value="${fieldValue(bean:attrs.i,field:'flightTestBadCourseStartLandingPoints')}" tabIndex="22"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestLandingToLatePoints" name="flightTestLandingToLatePoints" value="${fieldValue(bean:attrs.i,field:'flightTestLandingToLatePoints')}" tabIndex="23"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestGivenToLatePoints" name="flightTestGivenToLatePoints" value="${fieldValue(bean:attrs.i,field:'flightTestGivenToLatePoints')}" tabIndex="24"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestSafetyAndRulesInfringementPoints" name="flightTestSafetyAndRulesInfringementPoints" value="${fieldValue(bean:attrs.i,field:'flightTestSafetyAndRulesInfringementPoints')}" tabIndex="25"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestInstructionsNotFollowedPoints" name="flightTestInstructionsNotFollowedPoints" value="${fieldValue(bean:attrs.i,field:'flightTestInstructionsNotFollowedPoints')}" tabIndex="26"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestFalseEnvelopeOpenedPoints" name="flightTestFalseEnvelopeOpenedPoints" value="${fieldValue(bean:attrs.i,field:'flightTestFalseEnvelopeOpenedPoints')}" tabIndex="27"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestSafetyEnvelopeOpenedPoints" name="flightTestSafetyEnvelopeOpenedPoints" value="${fieldValue(bean:attrs.i,field:'flightTestSafetyEnvelopeOpenedPoints')}" tabIndex="28"/>"""
        ...
        outln"""            <br/>"""
        outln"""            <input type="text" id="flightTestFrequencyNotMonitoredPoints" name="flightTestFrequencyNotMonitoredPoints" value="${fieldValue(bean:attrs.i,field:'flightTestFrequencyNotMonitoredPoints')}" tabIndex="29"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1MaxPoints" name="landingTest1MaxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1MaxPoints')}" tabIndex="31"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1NoLandingPoints" name="landingTest1NoLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1NoLandingPoints')}" tabIndex="32"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1OutsideLandingPoints" name="landingTest1OutsideLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1OutsideLandingPoints')}" tabIndex="33"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1RollingOutsidePoints" name="landingTest1RollingOutsidePoints" value="${fieldValue(bean:attrs.i,field:'landingTest1RollingOutsidePoints')}" tabIndex="34"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1PowerInBoxPoints" name="landingTest1PowerInBoxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1PowerInBoxPoints')}" tabIndex="35"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1GoAroundWithoutTouchingPoints" name="landingTest1GoAroundWithoutTouchingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1GoAroundWithoutTouchingPoints')}" tabIndex="36"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1GoAroundInsteadStopPoints" name="landingTest1GoAroundInsteadStopPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1GoAroundInsteadStopPoints')}" tabIndex="37"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1AbnormalLandingPoints" name="landingTest1AbnormalLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1AbnormalLandingPoints')}" tabIndex="38"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1NotAllowedAerodynamicAuxiliariesPoints" name="landingTest1NotAllowedAerodynamicAuxiliariesPoints" value="${fieldValue(bean:attrs.i,field:'landingTest1NotAllowedAerodynamicAuxiliariesPoints')}" tabIndex="39"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest1PenaltyCalculator" name="landingTest1PenaltyCalculator" value="${fieldValue(bean:attrs.i,field:'landingTest1PenaltyCalculator')}" tabIndex="40"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.maxpoints')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2MaxPoints" name="landingTest2MaxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2MaxPoints')}" tabIndex="41"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.nolanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2NoLandingPoints" name="landingTest2NoLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2NoLandingPoints')}" tabIndex="42"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.outsidelanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2OutsideLandingPoints" name="landingTest2OutsideLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2OutsideLandingPoints')}" tabIndex="43"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.rollingoutside')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2RollingOutsidePoints" name="landingTest2RollingOutsidePoints" value="${fieldValue(bean:attrs.i,field:'landingTest2RollingOutsidePoints')}" tabIndex="44"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.powerinbox')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2PowerInBoxPoints" name="landingTest2PowerInBoxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2PowerInBoxPoints')}" tabIndex="45"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundwithouttouching')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2GoAroundWithoutTouchingPoints" name="landingTest2GoAroundWithoutTouchingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2GoAroundWithoutTouchingPoints')}" tabIndex="46"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundinsteadstop')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2GoAroundInsteadStopPoints" name="landingTest2GoAroundInsteadStopPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2GoAroundInsteadStopPoints')}" tabIndex="47"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.abnormallanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2AbnormalLandingPoints" name="landingTest2AbnormalLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2AbnormalLandingPoints')}" tabIndex="48"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.notallowedaerodynamicauxiliaries')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2NotAllowedAerodynamicAuxiliariesPoints" name="landingTest2NotAllowedAerodynamicAuxiliariesPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2NotAllowedAerodynamicAuxiliariesPoints')}" tabIndex="49"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2PowerInAirPoints" name="landingTest2PowerInAirPoints" value="${fieldValue(bean:attrs.i,field:'landingTest2PowerInAirPoints')}" tabIndex="50"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.penaltycalculator')}*:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest2PenaltyCalculator" name="landingTest2PenaltyCalculator" value="${fieldValue(bean:attrs.i,field:'landingTest2PenaltyCalculator')}" tabIndex="51"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.maxpoints')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3MaxPoints" name="landingTest3MaxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3MaxPoints')}" tabIndex="61"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.nolanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3NoLandingPoints" name="landingTest3NoLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3NoLandingPoints')}" tabIndex="62"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.outsidelanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3OutsideLandingPoints" name="landingTest3OutsideLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3OutsideLandingPoints')}" tabIndex="63"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.rollingoutside')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3RollingOutsidePoints" name="landingTest3RollingOutsidePoints" value="${fieldValue(bean:attrs.i,field:'landingTest3RollingOutsidePoints')}" tabIndex="64"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.powerinbox')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3PowerInBoxPoints" name="landingTest3PowerInBoxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3PowerInBoxPoints')}" tabIndex="65"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundwithouttouching')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3GoAroundWithoutTouchingPoints" name="landingTest3GoAroundWithoutTouchingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3GoAroundWithoutTouchingPoints')}" tabIndex="66"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundinsteadstop')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3GoAroundInsteadStopPoints" name="landingTest3GoAroundInsteadStopPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3GoAroundInsteadStopPoints')}" tabIndex="67"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.abnormallanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3AbnormalLandingPoints" name="landingTest3AbnormalLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3AbnormalLandingPoints')}" tabIndex="68"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.notallowedaerodynamicauxiliaries')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3NotAllowedAerodynamicAuxiliariesPoints" name="landingTest3NotAllowedAerodynamicAuxiliariesPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3NotAllowedAerodynamicAuxiliariesPoints')}" tabIndex="69"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.powerinair')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3PowerInAirPoints" name="landingTest3PowerInAirPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3PowerInAirPoints')}" tabIndex="70"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3FlapsInAirPoints" name="landingTest3FlapsInAirPoints" value="${fieldValue(bean:attrs.i,field:'landingTest3FlapsInAirPoints')}" tabIndex="71"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.penaltycalculator')}*:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest3PenaltyCalculator" name="landingTest3PenaltyCalculator" value="${fieldValue(bean:attrs.i,field:'landingTest3PenaltyCalculator')}" tabIndex="72"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.maxpoints')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4MaxPoints" name="landingTest4MaxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4MaxPoints')}" tabIndex="81"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.nolanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4NoLandingPoints" name="landingTest4NoLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4NoLandingPoints')}" tabIndex="82"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.outsidelanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4OutsideLandingPoints" name="landingTest4OutsideLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4OutsideLandingPoints')}" tabIndex="83"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.rollingoutside')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4RollingOutsidePoints" name="landingTest4RollingOutsidePoints" value="${fieldValue(bean:attrs.i,field:'landingTest4RollingOutsidePoints')}" tabIndex="84"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.powerinbox')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4PowerInBoxPoints" name="landingTest4PowerInBoxPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4PowerInBoxPoints')}" tabIndex="85"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundwithouttouching')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4GoAroundWithoutTouchingPoints" name="landingTest4GoAroundWithoutTouchingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4GoAroundWithoutTouchingPoints')}" tabIndex="86"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.goaroundinsteadstop')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4GoAroundInsteadStopPoints" name="landingTest4GoAroundInsteadStopPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4GoAroundInsteadStopPoints')}" tabIndex="87"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.abnormallanding')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4AbnormalLandingPoints" name="landingTest4AbnormalLandingPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4AbnormalLandingPoints')}" tabIndex="88"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.notallowedaerodynamicauxiliaries')}* [${message(code:'fc.points')}]:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4NotAllowedAerodynamicAuxiliariesPoints" name="landingTest4NotAllowedAerodynamicAuxiliariesPoints" value="${fieldValue(bean:attrs.i,field:'landingTest4NotAllowedAerodynamicAuxiliariesPoints')}" tabIndex="89"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4TouchingObstaclePoints" name="landingTest4TouchingObstaclePoints" value="${fieldValue(bean:attrs.i,field:'landingTest4TouchingObstaclePoints')}" tabIndex="90"/>"""
        ...
        outln"""        <label>${message(code:'fc.landingtest.penaltycalculator')}*:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="landingTest4PenaltyCalculator" name="landingTest4PenaltyCalculator" value="${fieldValue(bean:attrs.i,field:'landingTest4PenaltyCalculator')}" tabIndex="91"/>"""
        ...
        outln"""        <br/>"""
        outln"""        <input type="text" id="printPointsPrintTitle" name="printPointsPrintTitle" value="${fieldValue(bean:attrs.i,field:'printPointsPrintTitle')}" tabIndex="100"/>"""
        outln"""    </p>"""
        outln"""    <p>"""
        outln"""        <div>"""
        checkBox("printPointsPlanningTest", attrs.i.printPointsPlanningTest, 'fc.planningtest') 
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsFlightTest", attrs.i.printPointsFlightTest, 'fc.flighttest')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsLandingTest1", attrs.i.printPointsLandingTest1, 'fc.landingtest.landing1')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsLandingTest2", attrs.i.printPointsLandingTest2, 'fc.landingtest.landing2')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsLandingTest3", attrs.i.printPointsLandingTest3, 'fc.landingtest.landing3')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsLandingTest4", attrs.i.printPointsLandingTest4, 'fc.landingtest.landing4')
        outln"""        </div>"""
        outln"""    </p>"""
        outln"""    <p>"""
        outln"""        <label>${message(code:'fc.general.printlandingcalculatorvalues')}:</label>"""
        outln"""        <br/>"""
        outln"""        <input type="text" id="printLandingCalculatorValues" name="printLandingCalculatorValues" value="${fieldValue(bean:attrs.i,field:'printLandingCalculatorValues')}" tabIndex="101"/>"""
        ...
        outln"""    <p>"""
        outln"""        <div>"""
        checkBox("printPointsZero", attrs.i.printPointsZero, 'fc.general.printpointszero')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsLandscape", attrs.i.printPointsLandscape, 'fc.printlandscape')
        outln"""        </div>"""
        outln"""        <div>"""
        checkBox("printPointsA3", attrs.i.printPointsA3, 'fc.printa3')
        outln"""        </div>"""
        outln"""    </p>"""
        outln"""</fieldset>"""
    }
    ...
    // --------------------------------------------------------------------------------------------------------------------
    private checkBox(String name, boolean checked, String label)
    {
