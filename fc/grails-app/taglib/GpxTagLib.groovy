class GpxTagLib
{
    ...
    def offlineViewerForm = { attrs, body ->
        ...
        outln"""                    xhttp.open("GET", "/fc/gpx/calculatexy?gpxFileName=${attrs.gpxFileName}&maxX=" + map.width + "&maxY=" + map.height + "&centerLat=" + center_lat + "&centerLon=" + center_lon + "&radius=" + radius_value + "&moveDir=" + move_dir, true);"""
        outln"""                    xhttp.send();"""
