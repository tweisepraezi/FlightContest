class LandingResultsTagLib 
{
	...
	def landingTest1Complete = { attrs, body ->
		if (attrs.crewResults) {
			outln"""<tr>"""
			outln"""    <th colspan="4">${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest1Points,false)}</th>"""
			outln"""</tr>"""
		} else {
        	outln"""<table>"""
			outln"""    <tbody>"""
	...
	def landingTest1Printable = { attrs, body ->
        ...
        outln"""       		<td>${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest1Points,true)}</td>"""
        outln"""        </tr>"""
        outln"""	</thead>"""
        outln"""    <tbody>"""
	...
	def landingTest2Complete = { attrs, body ->
		if (attrs.crewResults) {
			outln"""<tr>"""
			outln"""    <th colspan="4">${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest2Points,false)}</th>"""
			outln"""</tr>"""
		} else {
	        outln"""<table>"""
	        outln"""    <tbody>"""
	...
	def landingTest2Printable = { attrs, body ->
        ...
        outln"""       		<td>${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest2Points,true)}</td>"""
        outln"""        </tr>"""
        outln"""	</thead>"""
        outln"""    <tbody>"""
	...
	def landingTest3Complete = { attrs, body ->
		if (attrs.crewResults) {
			outln"""<tr>"""
			outln"""    <th colspan="4">${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest3Points,false)}</th>"""
			outln"""</tr>"""
		} else {
			outln"""<table>"""
			outln"""    <tbody>"""
	...
	def landingTest3Printable = { attrs, body ->
        ...
        outln"""       		<td>${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest3Points,true)}</td>"""
        outln"""        </tr>"""
        outln"""	</thead>"""
        outln"""    <tbody>"""
	...
	def landingTest4Complete = { attrs, body ->
		if (attrs.crewResults) {
			outln"""<tr>"""
			outln"""    <th colspan="4">${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest4Points,false)}</th>"""
			outln"""</tr>"""
		} else {
			outln"""<table>"""
			outln"""    <tbody>"""
	...
	def landingTest4Printable = { attrs, body ->
        ...
        outln"""       		<td>${attrs.t.GetLandingShortTitle(attrs.t.task.landingTest4Points,true)}</td>"""
        outln"""        </tr>"""
        outln"""	</thead>"""
        outln"""    <tbody>"""
