            ...
            if (attrs.t.GetTurnpointRoute().IsTurnpointSign() && attrs.t.IsObservationTestTurnpointRun()) {
                ...
                for (TurnpointData turnpointdata_instance in TurnpointData.findAllByTest(attrs.t,[sort:"id"])) {
                    if (attrs.t.IsObservationShown(turnpointdata_instance.tpTitle(), turnpoint_names) || attrs.t.IsObservationShown(turnpointdata_instance.tpPrintName(), turnpoint_names)) {
                        boolean is_disabled = DisabledCheckPointsTools.Contains(attrs.t.task.disabledCheckPointsTurnpointObs, turnpointdata_instance.route, "${turnpointdata_instance.tpTitle()},")
                        outln"""    <tr>"""
