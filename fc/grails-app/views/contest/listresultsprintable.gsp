<html>
    ...
    <body>
        <h2><g:if test="${contestInstance.contestPrintSubtitle}">${contestInstance.contestPrintSubtitle}</g:if><g:else>${message(code:'fc.contest.printresults')}</g:else><g:if test="${contestInstance.IsContestResultsProvisional(contestInstance.GetResultSettings(true),contestInstance.contestTaskResults)}"> [${message(code:'fc.provisional')}]</g:if></h2>
        <h3>${contestInstance.GetResultTitle(contestInstance.GetResultSettings(true),true)}</h3>
        <g:form>
            <table class="resultlist">
                <g:set var="landing_results_factor" value="${contestInstance.contestLandingResultsFactor}"/>
                <thead>
                    <tr>
                        ...
                        <g:elseif test="${contestInstance.contestPrintTAS}">
	                ...
	                <g:if test="${contestInstance.contestPrintTaskTestDetails}">
	                    <tr>
	                        <th/>
	                        <th/>
	                        <g:if test="${contestInstance.contestPrintAircraft || contestInstance.contestPrintTAS}">
	                            <th/>
	                        </g:if>
	                        <g:if test="${contestInstance.contestPrintTeam}">
	                            <th/>
	                        ...
	                        <g:if test="${contestInstance.contestPrintTaskDetails || contestInstance.contestPrintTaskTestDetails}">
	                            <g:each var="task_instance" in="${contestInstance.GetResultTasks(contestInstance.contestTaskResults)}">
	                                ...
	                                <g:if test="${task_instance in contestInstance.GetTestDetailsTasks(contestInstance.contestPrintTaskTestDetails)}">
	                                    ...
	                                    <g:if test="${contestInstance.contestSpecialResults && task_instance.IsSpecialTestRun()}">
	                                        <g:set var="detail_num" value="${detail_num+1}"/>
                                            <g:set var="specialtest_title" value="${task_instance.GetSpecialTestTitle()}"/>
                ...
                <tbody>
                    <g:each var="crew_instance" in="${Crew.findAllByContestAndDisabledAndNoContestPositionAndContestPenaltiesNotEqual(contestInstance,false,false,-1,[sort:'contestPosition'])}">
                        <tr id="${crew_instance.contestPosition}">
                            ...
                            <td class="crew"><g:if test="${contestInstance.contestPrintStartNum}">${crew_instance.startNum} - </g:if>${crew_instance.name}</td>
                            <g:if test="${contestInstance.contestPrintAircraft}">
                                <td class="aircraft"><g:if test="${crew_instance.aircraft}">${crew_instance.aircraft.registration}</g:if><g:else>-</g:else><g:if test="${contestInstance.contestPrintTAS}"> (${FcMath.SpeedStr_TAS(crew_instance.tas)}${message(code:'fc.knot')})</g:if></td>
                            </g:if>
                            <g:elseif test="${contestInstance.contestPrintTAS}">
                             	    ...
                             	    <g:if test="${test_instance}">
                                        ...
                                        <g:if test="${task_instance in contestInstance.GetTestDetailsTasks(contestInstance.contestPrintTaskTestDetails)}">
                                            ...
                                            <g:if test="${contestInstance.contestLandingResults && task_instance.IsLandingTestRun()}">
                                                <g:set var="landing_detail_written" value="${false}"/>
                                                <g:if test="${contestInstance.contestPrintLandingDetails}">
                                                    <g:set var="landing_test_complete" value="${true}"/>
                                                    <g:if test="${task_instance.IsLandingTest1Run()}">
                                                        <g:set var="detail_num" value="${detail_num+1}"/>
                                                        <g:if test="${test_instance.IsLandingTestRun() && test_instance.IsLandingTest1Run()}">
                                                            <td class="landingpenalties">${test_instance.landingTest1Penalties}<g:if test="${!test_instance.landingTest1Complete}"> [${message(code:'fc.provisional.short')}]<g:set var="test_provisional" value="${true}"/><g:set var="landing_test_complete" value="${false}"/></g:if></td>
                                                        </g:if>
                                                        <g:else>
                                                    ...
                                                    <g:if test="${task_instance.IsLandingTest2Run()}">
                                                        ...
                                                        <g:if test="${test_instance.IsLandingTestRun() && test_instance.IsLandingTest2Run()}">
                                                            <td class="landingpenalties">${test_instance.landingTest2Penalties}<g:if test="${!test_instance.landingTest2Complete}"> [${message(code:'fc.provisional.short')}]<g:set var="test_provisional" value="${true}"/><g:set var="landing_test_complete" value="${false}"/></g:if></td>
                                                        </g:if>
                                                        <g:else>
                                                            <td class="landingpenalties">-</td>
                                                        </g:else>
                                                    ...
                                                    <g:if test="${task_instance.IsLandingTest3Run()}">
                                                        ...
                                                        <g:if test="${test_instance.IsLandingTestRun() && test_instance.IsLandingTest3Run()}">
                                                            <td class="landingpenalties">${test_instance.landingTest3Penalties}<g:if test="${!test_instance.landingTest3Complete}"> [${message(code:'fc.provisional.short')}]<g:set var="test_provisional" value="${true}"/><g:set var="landing_test_complete" value="${false}"/></g:if></td>
                                                        </g:if>
                                                        <g:else>
                                                            <td class="landingpenalties">-</td>
                                                        </g:else>
                                                    ...
                                                    <g:if test="${task_instance.IsLandingTest4Run()}">
                                                        ...
                                                        <g:if test="${test_instance.IsLandingTestRun() && test_instance.IsLandingTest4Run()}">
                                                            <td class="landingpenalties">${test_instance.landingTest4Penalties}<g:if test="${!test_instance.landingTest4Complete}"> [${message(code:'fc.provisional.short')}]<g:set var="test_provisional" value="${true}"/><g:set var="landing_test_complete" value="${false}"/></g:if></td>
                                                        </g:if>
                                                        <g:else>
                                                            <td class="landingpenalties">-</td>
                                                        </g:else>
                                                ...
                                                <g:if test="${!landing_detail_written || landing_results_factor}">
                                                    ...
                                                    <g:if test="${test_instance.IsLandingTestRun()}">
                                                        <td class="landingpenalties">${FcMath.GetLandingPenalties(contestInstance.contestLandingResultsFactor, test_instance.landingTestPenalties)}<g:if test="${!landing_test_complete}"> [${message(code:'fc.provisional.short')}]<g:set var="test_provisional" value="${true}"/></g:if></td>
                                                    </g:if>
                                                    <g:else>
                                                        <td class="landingpenalties">-</td>
                                                    </g:else>
                            ...
                            <g:else>
                                <g:each var="task_instance" in="${contestInstance.GetResultTasks(contestInstance.contestTaskResults)}">
                                    <g:set var="test_instance" value="${Test.findByCrewAndTaskAndFlightTestAdditionalResult(crew_instance,task_instance,false)}"/>
                                    <g:if test="${test_instance}">
                                        <g:if test="${test_instance.IsTestResultsProvisional(contestInstance.GetResultSettings(true))}"><g:set var="test_provisional" value="${true}"/></g:if>
                                    </g:if>
                                </g:each>
                            </g:else>
			...
			<g:if test="${contestInstance.contestPrintFooter}">
				<br/>
				<table class="resultfooter">
					<tbody>
						<g:each var="foot_line" in="${Tools.Split(contestInstance.contestPrintFooter,Defs.RESULTS_FOOTER_LINE_SEPARATOR)}" status="i">
							<tr id="line${i+1}">
								<g:if test="${!foot_line}">
									<td><br/></td>
								</g:if>
