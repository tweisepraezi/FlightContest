                    ...
                    <g:form method="post">
                        <fieldset>
                            ...
                            <p>
                                ...
                                <br/>
                                <g:select optionKey="id" optionValue="${{it.name()}}" from="${Crew.findAllByOwnAircraftIsNull(sort:'name1')}" name="owner.id" value="${aircraftInstance?.owner?.id}" noSelection="['null':'']"></g:select>
                            </p>
                        </fieldset>
