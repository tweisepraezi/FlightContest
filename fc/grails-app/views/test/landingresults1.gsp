<html>
    <head>
        ...
        <title>${testInstance.GetTitle(ResultType.Landing1)}</title>
    </head>
    <body>
        ...
        <div class="box">
            ...
            <div class="box boxborder" >
                <h2>${testInstance.GetTitle(ResultType.Landing1)}</h2>
                <div class="block" id="forms" >
                    <g:form id="${testInstance.id}" method="post" >
                        <g:set var="ti" value="${[]+1}"/>
						<g:set var="next_id" value="${testInstance.GetNextTestID(ResultType.Landing1,session)}"/>
						<g:set var="prev_id" value="${testInstance.GetPrevTestID(ResultType.Landing1,session)}"/>
                        <table>
                            <tbody>
                                <tr>
						...
						<fieldset>
							<legend>${testInstance.GetLandingShortTitle(testInstance.task.landingTest1Points,false)}</legend>
							<g:if test="${!testInstance.landingTest1Complete}">
								<p>
								...
								<p>
									<div>
										<g:radioGroup name="landingTest1Landing" labels="${[message(code:'fc.landingtest.landing'),message(code:'fc.landingtest.nolanding')+" ("+Defs.LANDING_NO+")",message(code:'fc.landingtest.outsidelanding')+" ("+Defs.LANDING_OUT+")",message(code:'fc.landingtest.outsidelanding.short')+" ("+Defs.LANDING_OUT_SHORT+")",message(code:'fc.landingtest.outsidelanding.long')+" ("+Defs.LANDING_OUT_LONG+")"]}" values="[Defs.LANDING_SEL_VALUE,Defs.LANDING_SEL_NO,Defs.LANDING_SEL_OUT,Defs.LANDING_SEL_OUT_SHORT,Defs.LANDING_SEL_OUT_LONG]" value="${testInstance.landingTest1Landing}">
											<label>${it.radio} ${it.label}</label>
										</g:radioGroup>
										<g:if test="${testInstance.landingTest1Landing == Defs.LANDING_SEL_NO}">
											(${testInstance.GetLandingTestNoLandingPoints(testInstance.task.landingTest1Points)} ${message(code:'fc.points')})
										</g:if>
										<g:elseif test="${testInstance.landingTest1Landing == Defs.LANDING_SEL_OUT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest1Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest1Landing == Defs.LANDING_SEL_OUT_SHORT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest1Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest1Landing == Defs.LANDING_SEL_OUT_LONG}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest1Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:else>
								...
								<p>
                                    ...
                                    <br/>
                                    <g:textArea name="landingTest1Comment" value="${testInstance.landingTest1Comment}" rows="3" style="width:100%;" tabIndex="${ti[0]++}"/>
									<div>
                                        <g:checkBox name="landingTest1VideoCheck" value="${testInstance.landingTest1VideoCheck}"/>
                                        <label>${message(code:'fc.landingresults.videocheck')}</label>
                                    </div>
								</p>
                                <script>
									$('#landingTest1Measure').select();
								</script>
							</g:if>
							<g:else>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <g:if test="${!testInstance.landingTest1Penalties}">
                                        <g:set var="points_class" value="zeropoints"/>
                                    </g:if>
                                    <td class="${points_class}">${testInstance.landingTest1Penalties} ${message(code:'fc.points')}</td>
                                </tr>
                            </tbody>
                        </table>
                        <table>
                            <tfoot>
                                <tr>
                                    <td>
				                        <g:if test="${!testInstance.landingTest1Complete}">
				                        	<g:actionSubmit action="landingresultssave1" value="${message(code:'fc.save')}" tabIndex="${ti[0]++}"/>
				                            <g:if test="${next_id}">
				                                <g:actionSubmit action="landingresultsreadynext1" value="${message(code:'fc.results.readynext')}" tabIndex="${ti[0]++}"/>
				                            </g:if>
											<g:else>
												<g:actionSubmit action="landingresultsreadynext1" value="${message(code:'fc.results.readynext')}" disabled tabIndex="${ti[0]++}"/>
											</g:else>
				                        	<g:actionSubmit action="landingresultsready1" value="${message(code:'fc.results.ready')}" tabIndex="${ti[0]++}"/>
				                            <g:if test="${next_id}">
				                                <g:actionSubmit action="landingresultssavenext1" value="${message(code:'fc.results.savenext')}" tabIndex="${ti[0]++}"/>
				                                <g:actionSubmit action="landingresultsgotonext1" value="${message(code:'fc.results.gotonext')}" tabIndex="${ti[0]++}"/>
				                            </g:if>
											<g:else>
				                                <g:actionSubmit action="landingresultssavenext1" value="${message(code:'fc.results.savenext')}" disabled tabIndex="${ti[0]++}"/>
				                                <g:actionSubmit action="landingresultsgotonext1" value="${message(code:'fc.results.gotonext')}" disabled tabIndex="${ti[0]++}"/>
											</g:else>
											<g:if test="${prev_id}">
												<g:actionSubmit action="landingresultsgotoprev1" value="${message(code:'fc.results.gotoprev')}" tabIndex="${ti[0]++}"/>
											</g:if>
											<g:else>
												<g:actionSubmit action="landingresultsgotoprev1" value="${message(code:'fc.results.gotoprev')}" disabled tabIndex="${ti[0]++}"/>
											</g:else>
				                            <g:actionSubmit action="printlandingresults1" value="${message(code:'fc.print')}" tabIndex="${ti[0]++}"/>
				                        ...
				                        <g:else>
				                        	...
				                        	<g:actionSubmit action="landingresultsreopen1" value="${message(code:'fc.results.reopen')}" tabIndex="${ti[0]++}"/>
				                            <g:actionSubmit action="printlandingresults1" value="${message(code:'fc.print')}" tabIndex="${ti[0]++}"/>
			                                <g:actionSubmit action="cancel" value="${message(code:'fc.cancel')}" tabIndex="${ti[0]++}"/>
				                        </g:else>
                                    </td>
