                    ...
                    <g:form id="${testInstance.id}" method="post" >
						...
						<fieldset>
							...
							<g:if test="${!testInstance.landingTest3Complete}">
								...
								<p>
									<div>
										<g:radioGroup name="landingTest3Landing" labels="${[message(code:'fc.landingtest.landing'),message(code:'fc.landingtest.nolanding')+" ("+Defs.LANDING_NO+")",message(code:'fc.landingtest.outsidelanding')+" ("+Defs.LANDING_OUT+")",message(code:'fc.landingtest.outsidelanding.short')+" ("+Defs.LANDING_OUT_SHORT+")",message(code:'fc.landingtest.outsidelanding.long')+" ("+Defs.LANDING_OUT_LONG+")"]}" values="[Defs.LANDING_SEL_VALUE,Defs.LANDING_SEL_NO,Defs.LANDING_SEL_OUT,Defs.LANDING_SEL_OUT_SHORT,Defs.LANDING_SEL_OUT_LONG]" value="${testInstance.landingTest3Landing}">
											<label>${it.radio} ${it.label}</label>
										</g:radioGroup>
										<g:if test="${testInstance.landingTest3Landing == Defs.LANDING_SEL_NO}">
											(${testInstance.GetLandingTestNoLandingPoints(testInstance.task.landingTest3Points)} ${message(code:'fc.points')})
										</g:if>
										<g:elseif test="${testInstance.landingTest3Landing == Defs.LANDING_SEL_OUT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest3Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest3Landing == Defs.LANDING_SEL_OUT_SHORT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest3Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest3Landing == Defs.LANDING_SEL_OUT_LONG}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest3Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:else>
								...
								<p>
									...
									<br/>
									<g:textArea name="landingTest3Comment" value="${testInstance.landingTest3Comment}" rows="3" style="width:100%;" tabIndex="${ti[0]++}"/>
									<div>
                                        <g:checkBox name="landingTest3VideoCheck" value="${testInstance.landingTest3VideoCheck}"/>
