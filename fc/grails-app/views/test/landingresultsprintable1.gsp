<html>
    ...
    <body>
        ...
        <g:if test="${!testInstance.landingTest1Complete}">
            <h3>${testInstance?.task.printName()} (${message(code:'fc.version')} ${testInstance.GetLandingTest1Version()}) [${message(code:'fc.provisional')}]</h3>
        </g:if>
        <g:else>
            <h3>${testInstance?.task.printName()} (${message(code:'fc.version')} ${testInstance.GetLandingTest1Version()})</h3>
        </g:else>
        <div>
            <g:form>
