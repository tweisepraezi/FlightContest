    ...
    <head>
        <style type="text/css">
            @page {
                ...
                @top-left {
                    content: "${message(code:'fc.flightresults.aflos')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}"
                }
                @top-right {
        ...
        <title>${message(code:'fc.flightresults.aflos')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}</title>
    </head>
    <body>
        <div>
            <div>
