<html>
    <head>
        <style type="text/css">
            @page {
                ...
                @top-left {
                    ...
                    font-size: 90%;
                    content: "${message(code:'fc.flightresults.loggerdata')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}"
                }
                @top-right {
                    font-family: Noto Sans;
                    font-size: 90%;
        ...
        <title>${message(code:'fc.flightresults.loggerdata')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}</title>
    </head>
    <body>
        ...
        <div>
            <g:form>
                ...
                <br/>
                <g:flightTestLoggerDataPrintable t="${testInstance}"/>
            </g:form>
        </div>
    </body>
</html>