                    ...
                    <g:form id="${testInstance.id}" method="post" >
						...
						<fieldset>
							...
							<g:if test="${!testInstance.landingTest2Complete}">
								...
								<p>
									<div>
										<g:radioGroup name="landingTest2Landing" labels="${[message(code:'fc.landingtest.landing'),message(code:'fc.landingtest.nolanding')+" ("+Defs.LANDING_NO+")",message(code:'fc.landingtest.outsidelanding')+" ("+Defs.LANDING_OUT+")",message(code:'fc.landingtest.outsidelanding.short')+" ("+Defs.LANDING_OUT_SHORT+")",message(code:'fc.landingtest.outsidelanding.long')+" ("+Defs.LANDING_OUT_LONG+")"]}" values="[Defs.LANDING_SEL_VALUE,Defs.LANDING_SEL_NO,Defs.LANDING_SEL_OUT,Defs.LANDING_SEL_OUT_SHORT,Defs.LANDING_SEL_OUT_LONG]" value="${testInstance.landingTest2Landing}">
											<label>${it.radio} ${it.label}</label>
										</g:radioGroup>
										<g:if test="${testInstance.landingTest2Landing == Defs.LANDING_SEL_NO}">
											(${testInstance.GetLandingTestNoLandingPoints(testInstance.task.landingTest2Points)} ${message(code:'fc.points')})
										</g:if>
										<g:elseif test="${testInstance.landingTest2Landing == Defs.LANDING_SEL_OUT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest2Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest2Landing == Defs.LANDING_SEL_OUT_SHORT}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest2Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:elseif test="${testInstance.landingTest2Landing == Defs.LANDING_SEL_OUT_LONG}">
											(${testInstance.GetLandingTestOutsideLandingPoints(testInstance.task.landingTest2Points)} ${message(code:'fc.points')})
										</g:elseif>
										<g:else>
								...
								<p>
									...
									<br/>
									<g:textArea name="landingTest2Comment" value="${testInstance.landingTest2Comment}" rows="3" style="width:100%;" tabIndex="${ti[0]++}"/>
									<div>
                                        <g:checkBox name="landingTest2VideoCheck" value="${testInstance.landingTest2VideoCheck}"/>
