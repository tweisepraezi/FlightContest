<html>
    <head>
        <style type="text/css">
            @page {
                ...
                @top-left {
                    ...
                    content: "${message(code:'fc.flightresults.measure')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}"
                }
                @top-right {
                    font-family: Noto Sans;
        ...
        <title>${message(code:'fc.flightresults.measure')} ${testInstance.GetStartNum()} - ${testInstance?.task.printName()}</title>
    </head>
    <body>
        <h2>${message(code:'fc.flightresults.measure')} ${testInstance.GetStartNum()}</h2>
        ...
        <div>
            <g:form>
                <div style="page-break-inside:avoid">
                    ...
                    <g:flightTestMeasurementPrintable t="${testInstance}"/>
                </div>
