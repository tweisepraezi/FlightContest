<html>
    <head>
        ...
        <title>${message(code:'fc.contestdaytask.listplanning')}</title>
    </head>
    <body>
        ...
        <div class="box">
            ...
            <div class="box boxborder" >
                <h2>${message(code:'fc.contestdaytask.listplanning')}</h2>
                    ...
                    <table>
                        <tbody>
                            ...
                            <g:if test="${contestDayTaskInstance.planningtest}">
                                <tr>
                                    <td class="detailtitle" />
                                    <td><g:planningtest var="${contestDayTaskInstance.planningtest}" link="${createLink(controller:'planningTest',action:'show')}"/> (${contestDayTaskInstance.planningtest.planningtesttasks?.size()} ${message(code:'fc.planningtesttask.list')})</td>
                                </tr>
                            </g:if> <g:else>
                                <tr>
                                    <td class="detailtitle" />
                                    <td><g:link controller="planningTest" params="['contestdaytask.id':contestDayTaskInstance?.id,'contestdaytaskid':contestDayTaskInstance?.id,'fromlistplanning':true]" action="create">${message(code:'fc.planningtest.add')}</g:link></td>
                                </tr>
                            </g:else>
                            <g:if test="${contestDayTaskInstance.flighttest}">
                                ...
                                <tr>
                                    <td class="detailtitle" />
                                    <td><g:link controller="flightTest" params="['contestdaytask.id':contestDayTaskInstance?.id,'contestdaytaskid':contestDayTaskInstance?.id,'fromlistplanning':true]" action="create">${message(code:'fc.flighttest.add')}</g:link></td>
                                </tr>
                            </g:else>
                        </tbody>
                    </table>
