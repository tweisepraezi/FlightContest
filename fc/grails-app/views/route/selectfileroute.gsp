                ...
                <div class="block" id="forms" >
                    <g:uploadForm method="post">
                        ...
                        <div>
                            ...
                            <input type="text" id="foldername" name="foldername" value="turnpoints" tabIndex="${ti[0]++}"/>
                        </div>
                        <div>
                        ...
                        <p>
                            ...
                            <div>
                                ...
                                <input type="text" id="todirection" name="todirection" value="270" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                            </div>
                            <g:if test="${!contestInstance.precisionFlying}" >
                                ...
                                <div>
                                    ...
                                    <input type="text" id="semicirclepos1" name="semicirclepos1" value="6" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="semicirclepos2" name="semicirclepos2" value="9" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="semicirclepos3" name="semicirclepos3" value="12" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                                </div>
                                <g:if test="${!contestInstance.anrFlying}" >
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="ildgpos" name="ildgpos" value="12" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                                    </div>
                                    <div>
                                        <label>${message(code:'fc.gatedirection')}* [${message(code:'fc.grad')}]:</label>
                                        <input type="text" id="ildgdirection" name="ildgdirection" value="270" maxlength="3" size="3" tabIndex="${ti[0]++}"/>
                                    </div>
                                </g:if>
                            </g:if>
                            <br/>
                            ...
                            <g:if test="${contestInstance.precisionFlying}" >
                                ...
                                <div>
                                    ...
                                    <input type="text" id="secretcoursechange" name="secretcoursechange" value="1.5" maxlength="5" size="3" tabIndex="${ti[0]++}"/>
