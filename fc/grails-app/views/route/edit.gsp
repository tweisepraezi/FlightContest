                ...
                <div class="block" id="forms" >
                    ...
                    <g:form method="post" params="${['routeReturnAction':routeReturnAction,'routeReturnController':routeReturnController,'routeReturnID':routeReturnID]}">
                        ...
                        <fieldset>
                            ...
                            <g:if test="${routeInstance.contest.anrFlying || routeInstance.contest.corridorRoutes || routeInstance.corridorWidth}">
                                <g:if test="${!route_used}">
                                    <fieldset>
                                        ...
                                        <g:if test="${routeInstance.contest.anrFlying}">
                                            <br/>
                                            <div>
                                ...
                                <g:else>
                                    <g:if test="${routeInstance.contest.anrFlying && routeInstance.IsOtherRoute()}">
                                        <div>
                                            <label>${message(code:'fc.parcour.name')}:</label>
                                            <br/>
                                            <input type="text" id="parcourName" name="parcourName" value="${fieldValue(bean:routeInstance,field:'parcourName')}" tabIndex="${ti[0]++}"/>
                            ...
                            <g:editRouteSpecialSettings route="${routeInstance}" routeStatus="${route_status}" ti="${ti}"/>
