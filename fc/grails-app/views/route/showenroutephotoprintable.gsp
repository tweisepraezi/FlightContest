<html>
        ...
        <style type="text/css">
            @page {
                ...
                @top-left {
                    ...
                    font-size: 90%;
                    content: "${routeInstance.contest.name()} - ${routeInstance.printName()} - ${message(code:'fc.observation.enroute.photo.short')}"
                }
                @top-right {
                    font-family: Noto Sans;
                    font-size: 90%;
    ...
    <body>
        <g:printCoordEnroutePhoto route="${routeInstance}" params="${params}" />
    </body>
</html>