...
Fehlerbebung in Version 3.1.10.Patch1:
--------------------------------------
...
Erweiterungen in Version 3.1.5:
-------------------------------
- Möglichkeit der Vergrößerung der Wendepunkt-Nummern in Flugplänen eingeführt
    ...
    angepasst werden. Mehrere Kürzungen sind auch möglich.
...
- OSM-Wettbewerbs-Karten von Strecken, die nur T/O beinhalten
    ...
    Kombinationen von Links, Mitte, Rechts und Oben, Mitte, Unten.
- Aktualisierung folgender Regelwerke
...
- OSM-Wettbewerbs-Karte
    ...
    * Neue Option "Ortsnamen"
    * Neue Option "Farbkorrekturen zur Annäherung an die TÜK200"
- OSM-Online-Karte
    'Google Maps' wurde durch Leaflet ersetzt
- Wettbewerbs-Anonymisierung
    Ersetzt alle Besatzungs-Namen und Flugzeug-Kennzeichen durch eine laufende
    Bezeichnung und löscht E-Mail-Adressen.
    -> Wettbewerb -> Wettbewerb anonymisieren

Erweiterungen in Version 3.1.1:
-------------------------------
- OSM-Wettbewerbs-Karte
